...
class Piece {
	...
	static boolean kwcancast = true;
	
	static boolean kbcancast = true;
	
	static boolean twrightcancast = true;
	
	static boolean twleftcancast = true;
	
	static boolean tbrightcancast = true;
	
	static boolean tbleftcancast = true;
