			...
			if (turn) {
				...
				while (turn) {
					...
					if ((game.board[coordread.x][coordread.y]!=null) && (game.board[coordread.x][coordread.y].colour == true)) {
						...
						if (game.board[premove.x][premove.y].moveTo(game.board[premove.x][premove.y].abspos, new Coords(coordread.x,coordread.y), game.board)) turn = false;
				...
				while (!turn) {
					...
					if ((game.board[coordread.x][coordread.y]!=null) && (game.board[coordread.x][coordread.y].colour == false)) {
						...
						if (game.board[premove.x][premove.y].moveTo(game.board[premove.x][premove.y].abspos, new Coords(coordread.x,coordread.y), game.board)) turn = true;
